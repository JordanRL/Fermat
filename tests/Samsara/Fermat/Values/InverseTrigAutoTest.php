...
class InverseTrigAutoTest extends TestCase
{
    ...
    public function arcsinImmutableProvider(): array
    {
        ...
        $b = new ImmutableDecimal('0.5');
        $c = new ImmutableDecimal('0.1');
        $d = new ImmutableDecimal('0.0000000001');
        $e = new ImmutableDecimal(0);
        $f = new ImmutableDecimal(-1);
    ...
    public function arctanImmutableProvider(): array
    {
        ...
        $g = new ImmutableDecimal('0.0000000001');
        $h = new ImmutableDecimal(0);
        $i = new ImmutableDecimal(-1);
        $j = new ImmutableDecimal(-2);
        $k = new ImmutableDecimal(-3);
        $l = new ImmutableDecimal(-10);
        $m = new ImmutableDecimal(-100000000000);
        $n = new ImmutableDecimal('-1000000000000000000000000000000');
        $o = new ImmutableDecimal('-0.0000000001');
    ...
    public function arctanMutableProvider(): array
    {
        ...
        $h = new MutableDecimal(0);
        $i = new MutableDecimal(-1);
        $j = new MutableDecimal(-2);
        $k = new MutableDecimal(-3);
        $l = new MutableDecimal(-10);
        $m = new MutableDecimal(-100000000000);
        $n = new MutableDecimal('-1000000000000000000000000000000');
        $o = new MutableDecimal('-0.0000000001');
    ...
    public function arcsecImmutableProvider(): array
    {
        ...
        $e = new ImmutableDecimal(100000000000);
        $f = new ImmutableDecimal('1000000000000000000000000000000');
        $g = new ImmutableDecimal(-1);
        $h = new ImmutableDecimal(-2);
        $i = new ImmutableDecimal(-3);
    ...
    public function arcsecMutableProvider(): array
    {
        ...
        $e = new MutableDecimal(100000000000);
        $f = new MutableDecimal('1000000000000000000000000000000');
        $g = new MutableDecimal(-1);
        $h = new MutableDecimal(-2);
        $i = new MutableDecimal(-3);
        $j = new MutableDecimal(-10);
        $k = new MutableDecimal(-100000000000);
        $l = new MutableDecimal('-1000000000000000000000000000000');
    ...
    public function arccotImmutableProvider(): array
    {
        ...
        $f = new ImmutableDecimal('1000000000000000000000000000000');
        $g = new ImmutableDecimal('0.0000000001');
        $h = new ImmutableDecimal('-1');
        $i = new ImmutableDecimal('-2');
        $j = new ImmutableDecimal('-3');
        $k = new ImmutableDecimal('-10');
        $l = new ImmutableDecimal('-100000000000');
        $m = new ImmutableDecimal('-1000000000000000000000000000000');
        $n = new ImmutableDecimal('-0.0000000001');
    ...
    public function arccotMutableProvider(): array
    {
        ...
        $f = new MutableDecimal('1000000000000000000000000000000');
        $g = new MutableDecimal('0.0000000001');
        $h = new MutableDecimal('-1');
        $i = new MutableDecimal('-2');
        $j = new MutableDecimal('-3');
        $k = new MutableDecimal('-10');
        $l = new MutableDecimal('-100000000000');
        $m = new MutableDecimal('-1000000000000000000000000000000');
        $n = new MutableDecimal('-0.0000000001');
