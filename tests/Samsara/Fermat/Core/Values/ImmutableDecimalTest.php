...
class ImmutableDecimalTest extends TestCase
{
    ...
    public function testObjectEquality()
    {
        ...
        $this->assertEquals('Samsara\\Fermat\\Core\\Values\\ImmutableDecimal12', $in1->hash());
        $this->assertEquals('Samsara\\Fermat\\Core\\Values\\ImmutableDecimal12', $in2->hash());
        $this->assertEquals('Samsara\\Fermat\\Core\\Values\\ImmutableDecimal16', $in3->hash());
