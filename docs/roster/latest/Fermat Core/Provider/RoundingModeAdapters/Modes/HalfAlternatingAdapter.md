# Samsara\Fermat\Core\Provider\RoundingModeAdapters\Modes > HalfAlternatingAdapter
...
!!! signature "public HalfAlternatingAdapter->determineCarry(int $digit, int $nextDigit)"
    ##### determineCarry
    **$digit**
