...
class InverseTrigPrecisionTest extends TestCase
{
    ...
    public function arcsinImmutableProvider(): array
    {
        ...
        $b = (new ImmutableDecimal('0.5'))->setMode(CalcMode::Precision);
        $c = (new ImmutableDecimal('0.1'))->setMode(CalcMode::Precision);
        $d = (new ImmutableDecimal('0.0000000001'))->setMode(CalcMode::Precision);
        $e = (new ImmutableDecimal(0))->setMode(CalcMode::Precision);
        $f = (new ImmutableDecimal(-1))->setMode(CalcMode::Precision);
        $g = (new ImmutableDecimal('-0.5'))->setMode(CalcMode::Precision);
        $h = (new ImmutableDecimal('-0.1'))->setMode(CalcMode::Precision);
        $i = (new ImmutableDecimal('-0.0000000001'))->setMode(CalcMode::Precision);
    ...
    public function arctanImmutableProvider(): array
    {
        ...
        $g = (new ImmutableDecimal('0.0000000001'))->setMode(CalcMode::Precision);
        $h = (new ImmutableDecimal(0))->setMode(CalcMode::Precision);
        $i = (new ImmutableDecimal(-1))->setMode(CalcMode::Precision);
        $j = (new ImmutableDecimal(-2))->setMode(CalcMode::Precision);
        $k = (new ImmutableDecimal(-3))->setMode(CalcMode::Precision);
        $l = (new ImmutableDecimal(-10))->setMode(CalcMode::Precision);
        $m = (new ImmutableDecimal(-100000000000))->setMode(CalcMode::Precision);
        $n = (new ImmutableDecimal('-1000000000000000000000000000000'))->setMode(CalcMode::Precision);
        $o = (new ImmutableDecimal('-0.0000000001'))->setMode(CalcMode::Precision);
        ...
        return [
            ...
            'IDecimal arctan(-1000000000000000000000000000000)' => [$n, '-1.5707963268', NumberBase::Ten, 10],
    ...
    public function arctanMutableProvider(): array
    {
        ...
        $h = (new MutableDecimal(0))->setMode(CalcMode::Precision);
        $i = (new MutableDecimal(-1))->setMode(CalcMode::Precision);
        $j = (new MutableDecimal(-2))->setMode(CalcMode::Precision);
        $k = (new MutableDecimal(-3))->setMode(CalcMode::Precision);
        $l = (new MutableDecimal(-10))->setMode(CalcMode::Precision);
        $m = (new MutableDecimal(-100000000000))->setMode(CalcMode::Precision);
        $n = (new MutableDecimal('-1000000000000000000000000000000'))->setMode(CalcMode::Precision);
        $o = (new MutableDecimal('-0.0000000001'))->setMode(CalcMode::Precision);
        ...
        return [
            ...
            'MDecimal arctan(1000000000000000000000000000000)' => [$f, '1.5707963268', NumberBase::Ten, 10],
            ...
            'MDecimal arctan(-1000000000000000000000000000000)' => [$n, '-1.5707963268', NumberBase::Ten, 10],
    ...
    public function arcsecImmutableProvider(): array
    {
        ...
        $e = (new ImmutableDecimal(100000000000))->setMode(CalcMode::Precision);
        $f = (new ImmutableDecimal('1000000000000000000000000000000'))->setMode(CalcMode::Precision);
        $g = (new ImmutableDecimal(-1))->setMode(CalcMode::Precision);
        $h = (new ImmutableDecimal(-2))->setMode(CalcMode::Precision);
        $i = (new ImmutableDecimal(-3))->setMode(CalcMode::Precision);
        $j = (new ImmutableDecimal(-10))->setMode(CalcMode::Precision);
        $k = (new ImmutableDecimal(-100000000000))->setMode(CalcMode::Precision);
        $l = (new ImmutableDecimal('-1000000000000000000000000000000'))->setMode(CalcMode::Precision);
        ...
        return [
            ...
            'IDecimal arcsec(1000000000000000000000000000000)' => [$f, '1.5707963268', NumberBase::Ten, 10],
    ...
    public function arcsecMutableProvider(): array
    {
        ...
        $e = (new MutableDecimal(100000000000))->setMode(CalcMode::Precision);
        $f = (new MutableDecimal('1000000000000000000000000000000'))->setMode(CalcMode::Precision);
        $g = (new MutableDecimal(-1))->setMode(CalcMode::Precision);
        $h = (new MutableDecimal(-2))->setMode(CalcMode::Precision);
        $i = (new MutableDecimal(-3))->setMode(CalcMode::Precision);
        $j = (new MutableDecimal(-10))->setMode(CalcMode::Precision);
        $k = (new MutableDecimal(-100000000000))->setMode(CalcMode::Precision);
        $l = (new MutableDecimal('-1000000000000000000000000000000'))->setMode(CalcMode::Precision);
        ...
        return [
            ...
            'MDecimal arcsec(1000000000000000000000000000000)' => [$f, '1.5707963268', NumberBase::Ten, 10],
            ...
            'MDecimal arcsec(-1000000000000000000000000000000)' => [$l, '1.5707963268', NumberBase::Ten, 10],
        ];
    }
    ...
    public function arccscImmutableProvider(): array
    {
        ...
        return [
            ...
            'IDecimal arccsc(1000000000000000000000000000000)' => [$f, '0', NumberBase::Ten, 10],
    ...
    public function arccscMutableProvider(): array
    {
        ...
        return [
            ...
            'MDecimal arccsc(1000000000000000000000000000000)' => [$f, '0', NumberBase::Ten, 10],
    ...
    public function arccotImmutableProvider(): array
    {
        ...
        $f = (new ImmutableDecimal('1000000000000000000000000000000'))->setMode(CalcMode::Precision);
        $g = (new ImmutableDecimal('0.0000000001'))->setMode(CalcMode::Precision);
        $h = (new ImmutableDecimal('-1'))->setMode(CalcMode::Precision);
        $i = (new ImmutableDecimal('-2'))->setMode(CalcMode::Precision);
        $j = (new ImmutableDecimal('-3'))->setMode(CalcMode::Precision);
        $k = (new ImmutableDecimal('-10'))->setMode(CalcMode::Precision);
        $l = (new ImmutableDecimal('-100000000000'))->setMode(CalcMode::Precision);
        $m = (new ImmutableDecimal('-1000000000000000000000000000000'))->setMode(CalcMode::Precision);
        $n = (new ImmutableDecimal('-0.0000000001'))->setMode(CalcMode::Precision);
        ...
        return [
            ...
            'IDecimal arccot(1000000000000000000000000000000)' => [$f, '0', NumberBase::Ten, 10],
    ...
    public function arccotMutableProvider(): array
    {
        ...
        $f = (new MutableDecimal('1000000000000000000000000000000'))->setMode(CalcMode::Precision);
        $g = (new MutableDecimal('0.0000000001'))->setMode(CalcMode::Precision);
        $h = (new MutableDecimal('-1'))->setMode(CalcMode::Precision);
        $i = (new MutableDecimal('-2'))->setMode(CalcMode::Precision);
        $j = (new MutableDecimal('-3'))->setMode(CalcMode::Precision);
        $k = (new MutableDecimal('-10'))->setMode(CalcMode::Precision);
        $l = (new MutableDecimal('-100000000000'))->setMode(CalcMode::Precision);
        $m = (new MutableDecimal('-1000000000000000000000000000000'))->setMode(CalcMode::Precision);
        $n = (new MutableDecimal('-0.0000000001'))->setMode(CalcMode::Precision);
        ...
        return [
            ...
            'MDecimal arccot(1000000000000000000000000000000)' => [$f, '0', NumberBase::Ten, 10],
