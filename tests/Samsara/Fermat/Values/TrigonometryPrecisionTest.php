 ...
 */
class TrigonometryPrecisionTest extends TestCase
{
    ...
    public function sinImmutableProvider(): array
    {
        ...
        $h = (new ImmutableDecimal(Numbers::makePi(10), 10))->setMode(CalcMode::Precision);
        $i = (new ImmutableDecimal(Numbers::makePi(15), 15))->setMode(CalcMode::Precision);
        $j = (new ImmutableDecimal(Numbers::makeTau(10), 10))->setMode(CalcMode::Precision);
        $k = (new ImmutableDecimal(Numbers::makeTau(15), 15))->setMode(CalcMode::Precision);
        $l = (new ImmutableDecimal(0))->setMode(CalcMode::Precision);
        $m = (new ImmutableDecimal(Numbers::makePi(12)->divide(2)->truncateToScale(10), 10))->setMode(CalcMode::Precision);
        $n = (new ImmutableDecimal(Numbers::makePi(17)->divide(2)->truncateToScale(15), 15))->setMode(CalcMode::Precision);
    ...
    public function sinMutableProvider(): array
    {
        ...
        $h = (new MutableDecimal(Numbers::makePi(10), 10))->setMode(CalcMode::Precision);
        $i = (new MutableDecimal(Numbers::makePi(15), 15))->setMode(CalcMode::Precision);
        $j = (new MutableDecimal(Numbers::makeTau(10), 10))->setMode(CalcMode::Precision);
        $k = (new MutableDecimal(Numbers::makeTau(15), 15))->setMode(CalcMode::Precision);
        $l = (new MutableDecimal(0))->setMode(CalcMode::Precision);
        $m = (new MutableDecimal(Numbers::makePi(12)->divide(2)->truncateToScale(10), 10))->setMode(CalcMode::Precision);
        $n = (new MutableDecimal(Numbers::makePi(17)->divide(2)->truncateToScale(15), 15))->setMode(CalcMode::Precision);
    ...
    public function cosImmutableProvider(): array
    {
        ...
        $m = (new ImmutableDecimal(Numbers::makePi(12)->divide(2)->truncateToScale(10), 10))->setMode(CalcMode::Precision);
        $n = (new ImmutableDecimal(Numbers::makePi(17)->divide(2)->truncateToScale(15), 15))->setMode(CalcMode::Precision);
        $o = (new ImmutableDecimal(Numbers::makePi(12)->multiply(3)->divide(2)->truncateToScale(10), 10))->setMode(CalcMode::Precision);
        $p = (new ImmutableDecimal(Numbers::makePi(17)->multiply(3)->divide(2)->truncateToScale(15), 15))->setMode(CalcMode::Precision);
