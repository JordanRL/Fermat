...
class ArithmeticAutoTest extends TestCase
{
    ...
    public function divisionImmutableDecimalProvider(): array
    {
        ...
        return [
            [$a, $b, '0.6666666667', NumberBase::Ten, 10],
            [$a2, $b, '0.131313131002111', NumberBase::Five, 10],
            [$a, $c, '-1', NumberBase::Ten, 10],
            [$b, $c, '-1.5', NumberBase::Ten, 10],
            [$c, $d, '0.6666666667', NumberBase::Ten, 10],
            [$a, $e, '4', NumberBase::Ten, 10],
            [$b, $e, '6', NumberBase::Ten, 10],
            [$a, $f, '-4', NumberBase::Ten, 10],
            [$b, $f, '-6', NumberBase::Ten, 10],
            [$a, $g, '20000000000', NumberBase::Ten, 10],
            [$a, $h, '200000000000', NumberBase::Ten, 10],
            [$a, $i, '0', NumberBase::Ten, 10],
            [$g, $i, '0', NumberBase::Ten, 10],
            [$a, $j, '-0.4i', NumberBase::Ten, 10],
            [$j, $a, '2.5i', NumberBase::Ten, 10],
            [$j, $k, '0.5', NumberBase::Ten, 10],
            [$a, $l, IntegrityConstraint::class, NumberBase::Ten, 10]
        ];
    }
    ...
    public function divisionImmutableFractionProvider(): array
    {
        ...
        return [
            [$a, $b, '5/4', NumberBase::Ten, 10],
            [$a, $c, '1/3', NumberBase::Ten, 10],
            [$b, $d, '1/4', NumberBase::Ten, 10],
            [$b, $c, '4/15', NumberBase::Ten, 10],
            [$a, $d, '5/16', NumberBase::Ten, 10],
            [$a, $e, '1/2', NumberBase::Ten, 10],
            [$e, $a, '2/1', NumberBase::Ten, 10],
            [$a, $f, '2500000000000000000000000/3', NumberBase::Ten, 10]
        ];
    }
